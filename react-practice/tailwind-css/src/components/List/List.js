							...
							<tbody className="bg-slate-700 divide-y divide-gray-200">
								...
								{people.map((person) => (
									<tr key={person.email}>
										...
										<td className="px-6 py-4 whitespace-nowrap">
											<span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-opacity-20 bg-white text-white">
												Active
											</span>
										</td>
										...
										<td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
											<p className="cursor-pointer text-white">Edit</p>
										</td>
									</tr>
								))}
							</tbody>
